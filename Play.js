...
export default class Play extends Scene {
    ...
    async init() {
        ...
        const res = await fetch(`${BASE_URL}assets/anim/mgk.json`);
        const mgkConfig = await res.json();

         const res2 = await fetch(`${BASE_URL}assets/anim/stereo.json`);
        const stereoConfig = await res2.json();
